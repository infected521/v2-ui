...
crt_key() {
    ...
    echo ""
    echo "agregar el directorio del certificado en el panel [certificate file path] /${keyssl}.crt"
    echo "agregar el directorio de la key en el panel [key file path] /${keyssl}.key"
    echo "------------------------------------------"
